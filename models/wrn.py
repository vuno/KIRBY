...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropRate=0.0, dataset='cifar'):
        ...
        self.conv1 = nn.Conv2d(init_ch, nChannels[0], kernel_size=3, stride=1,
                               padding=1, bias=False)
        # 1st block
